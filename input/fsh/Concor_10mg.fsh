...
Instance: Concor-10-mg-Comprimido-revestido
InstanceOf: MedicationKnowledgePDH
Description: "Example of MedicationKnowledge resource for Concor 10 mg comprimido revestido"


* code = http://infarmed.pt/medicamentos/prod_id#2142 "Concor 10 mg [C07AB07]"
* name = "Concor [Bisoprolol] 10 mg Comprimido revestido"

// Active ingredient: cada comprimido contém 10 mg de bisoprolol, fumarato
...
// Excipiente exclusivo da dosagem de 10 mg (comprimido laranja claro)
* definitional.ingredient[+].item = http://infarmed.pt/substancia#[PREENCHER] "Óxido de ferro vermelho (E172)"
* definitional.ingredient[=].type = http://terminology.hl7.org/CodeSystem/v3-RoleClass#IACT
...
* clinicalUseIssue[+] = Reference(Concor10mg-CUD-contra1)
* clinicalUseIssue[+] = Reference(Concor10mg-CUD-contra2)
* clinicalUseIssue[+] = Reference(Concor10mg-CUD-contra3)
* clinicalUseIssue[+] = Reference(Concor10mg-CUD-contra4)
* clinicalUseIssue[+] = Reference(Concor10mg-CUD-contra5)
* clinicalUseIssue[+] = Reference(Concor10mg-CUD-contra6)
* clinicalUseIssue[+] = Reference(Concor10mg-CUD-contra7)
* clinicalUseIssue[+] = Reference(Concor10mg-CUD-contra8)
* clinicalUseIssue[+] = Reference(Concor10mg-CUD-contra9)
* clinicalUseIssue[+] = Reference(Concor10mg-CUD-contra10)
* clinicalUseIssue[+] = Reference(Concor10mg-CUD-contra11)
* clinicalUseIssue[+] = Reference(Concor10mg-CUD-contra12)
* clinicalUseIssue[+] = Reference(Concor10mg-CUD-ind1)
* clinicalUseIssue[+] = Reference(Concor10mg-CUD-ind2)
* clinicalUseIssue[+] = Reference(Concor10mg-CUD-int1)
* clinicalUseIssue[+] = Reference(Concor10mg-CUD-int2)
* clinicalUseIssue[+] = Reference(Concor10mg-CUD-int3)
* clinicalUseIssue[+] = Reference(Concor10mg-CUD-int4)
* clinicalUseIssue[+] = Reference(Concor10mg-CUD-int5)
* clinicalUseIssue[+] = Reference(Concor10mg-CUD-int6)
* clinicalUseIssue[+] = Reference(Concor10mg-CUD-int7)
* clinicalUseIssue[+] = Reference(Concor10mg-CUD-int8)
* clinicalUseIssue[+] = Reference(Concor10mg-CUD-int9)
* clinicalUseIssue[+] = Reference(Concor10mg-CUD-int10)
* clinicalUseIssue[+] = Reference(Concor10mg-CUD-int11)
* clinicalUseIssue[+] = Reference(Concor10mg-CUD-int12)
* clinicalUseIssue[+] = Reference(Concor10mg-CUD-int13)
...
Instance: Concor10mg-CUD-contra1
...
Instance: Concor10mg-CUD-contra2
InstanceOf: ContraIndicacoesPDH
...
Instance: Concor10mg-CUD-contra3
InstanceOf: ContraIndicacoesPDH
...
Instance: Concor10mg-CUD-contra4
InstanceOf: ContraIndicacoesPDH
...
Instance: Concor10mg-CUD-contra5
InstanceOf: ContraIndicacoesPDH
...
Instance: Concor10mg-CUD-contra6
InstanceOf: ContraIndicacoesPDH
...
Instance: Concor10mg-CUD-contra7
InstanceOf: ContraIndicacoesPDH
...
Instance: Concor10mg-CUD-contra8
InstanceOf: ContraIndicacoesPDH
...
Instance: Concor10mg-CUD-contra9
InstanceOf: ContraIndicacoesPDH
...
Instance: Concor10mg-CUD-contra10
InstanceOf: ContraIndicacoesPDH
...
Instance: Concor10mg-CUD-contra11
InstanceOf: ContraIndicacoesPDH
...
Instance: Concor10mg-CUD-contra12
InstanceOf: ContraIndicacoesPDH
